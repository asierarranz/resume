...
* Form a team of web designers, developers, and creative technologists to collaborate across the organization.  
...
*Full-time fellowship (Oculus Acceleration Program) (June 2018 - Dec 2018)*  
...
* Launch new products from the lab to position the business school as one of the most innovative in the world  
...
* (2014/01/28) Evaluator of the projects presented to the European Commission project FiWare (Sao Paulo, Brasil)  
...
* Quantum Computing Unity Asset: A component that allows the Unity Game Engine to be connected to a real Quantum Computer [[Source code]](https://github.com/asierarranz/AskSkynet)  

* QBitSign: Timestamp and certification based on a quantum computer and the blockchain [[Link]](https://www.qbitsign.com)  

* Google Glass BBVA App: An application made on Google Glass connected to the corporate Google calendar of BBVA that provides scheduling capabilities and other features to the employees.  
